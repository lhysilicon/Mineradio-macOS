...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // Platform marker so the UI can drop the in-titlebar min/max/close on macOS,
  // where native traffic-light buttons (top-left) are used instead.
  document.documentElement.classList.add(process.platform === 'darwin' ? 'is-mac' : 'is-win');
});
